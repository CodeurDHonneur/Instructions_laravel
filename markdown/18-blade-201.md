...
On peut apporter les modifications suivantes suivantes à nos routes précédentes 
 ```php
...
Ensuite, on ouvre le fichier `app/Providers/AppServiceProvider`, et on remplit le tableau `$policies` :
```php
